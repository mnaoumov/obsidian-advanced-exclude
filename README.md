...
2. Downloading `advanced-exclude-demo-vault.zip` from the [Releases](https://github.com/mnaoumov/obsidian-advanced-exclude/releases). It unzips into a single `advanced-exclude-demo-vault-<version>` folder.
