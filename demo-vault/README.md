...
- **Otherwise**, download `advanced-exclude-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-advanced-exclude/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `advanced-exclude-demo-vault-<version>` folder it unzips into.
